  ...
  run: async (client, interaction) => {
    ...
    try {
      if (!queue || !queue.playing) {
        return interaction.reply({ content: '⚠️ ไมม่มีเพลงที่กำลังเล่น!', ephemeral: true });
      }
      ...
      const embed = new EmbedBuilder()
        ...
        .setDescription(success ? '**หยุดเพลงทำให้ความสุขหมด!**' : '❌ คำสั่งผิดพลาด: ไม่สามารถหยุดเพลงได้')
